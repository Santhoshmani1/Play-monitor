...
const Features = () => {
    ...
    return (
        <div className="p-2 font-sans bg-slate-100 lg:grid-cols-1 lg:items-center lg:grid justify-items-center" tabIndex={-1}>
            {
                        ...
                        <>
                            <div key={index} className='flex flex-col items-center justify-center my-8 mx-uto searchbar'>
                                <div className="flex items-center">
                                    ...
                                    <h2 className='px-6 py-4 font-sans text-3xl font-bold leading-tight text-center text-orange-500 lg:text-4xl lg:px-12 lg:leading-tight animate-pulse' style={{ letterSpacing: "0.10px" }}>
                                        {feature.title}
                                    </h2>
                                </div>
                                <p className="w-3/4 p-2 leading-relaxed text-center text-gray-800 lg:text-lg">{feature.description}</p>
                                <img src={feature.previewImage} alt="" className="w-3/4 h-auto rounded lg:w-3/5" />
                            </div>
                        </>
                    )
                })
